...
function drawElevi(){
    var str="";
    var strHead=`
    <tr><th><input type="button" value="Sorteaza ascendent dupa medie" onclick="sortAscMedie(event);" style="width:250px;"></th></tr>
			<tr><th><input type="button" value="Sorteaza descendent dupa medie" onclick="sortDescMedie(event);" style="width:250px;"></th></tr><tr>
    <th>Nume</th>
    <th>Medie</th>
    <th></th>
</tr>`;
